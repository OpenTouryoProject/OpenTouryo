...
<Serializable> _
Public Class ts_test_table1Entity
	#Region "メンバ変数"
	...
	Private _ts As Nullable(Of System.Double)

	''' <summary>プロパティ：ts</summary>
	Public Property ts() As Nullable(Of System.Double)
		Get
			Return Me._ts
		End Get
		Set
	...
	Private _Set_ts_forUPD As Nullable(Of System.Double)

	''' <summary>プロパティ：Set_ts_forUPD</summary>
	Public Property Set_ts_forUPD() As Nullable(Of System.Double)
		Get
	...
	Private _ts_Like As Nullable(Of System.Double)

	''' <summary>プロパティ：ts_Like</summary>
	Public Property ts_Like() As Nullable(Of System.Double)
		Get
			Return Me._ts_Like
		End Get
		Set
