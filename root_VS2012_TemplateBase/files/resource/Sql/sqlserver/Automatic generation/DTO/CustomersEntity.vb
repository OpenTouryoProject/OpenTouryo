...
Public Class CustomersEntity
	...
	Public IsSetPK_CustomerID As Boolean = False

	''' <summary>メンバ変数：CustomerID</summary>
	Private _PK_CustomerID As System.String

	''' <summary>プロパティ：CustomerID</summary>
	Public Property PK_CustomerID() As System.String
		Get
			Return Me._PK_CustomerID
		End Get
		Set
			Me.IsSetPK_CustomerID = True
			Me._PK_CustomerID = value
		End Set
	End Property
