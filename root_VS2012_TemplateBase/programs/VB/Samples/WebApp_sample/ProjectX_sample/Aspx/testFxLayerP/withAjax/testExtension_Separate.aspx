<%@ Page Language="VB" MasterPageFile="~/Aspx/Common/testAspNetAjaxExtension_Separate.master" AutoEventWireup="true" CodeFile="testExtension_Separate.aspx.vb" Inherits="Aspx_testFxLayerP_withAjax_testExtension_Separate" Title="Untitled Page" %>
