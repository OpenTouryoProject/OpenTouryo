...
Public Class DaoProducts
	...
	Public Property ProductName() As Object
		Get
			Return Me.HtParameter("ProductName")
		End Get
		Set
			Me.HtParameter("ProductName") = value
		End Set
	End Property
	...
	Public Property QuantityPerUnit() As Object
		Get
			Return Me.HtParameter("QuantityPerUnit")
		End Get
		Set
			Me.HtParameter("QuantityPerUnit") = value
		End Set
	End Property
	...
	Public Property UnitsInStock() As Object
		Get
			Return Me.HtParameter("UnitsInStock")
		End Get
		Set
			Me.HtParameter("UnitsInStock") = value
		End Set
	End Property
	...
	Public Property UnitsOnOrder() As Object
		Get
			Return Me.HtParameter("UnitsOnOrder")
		End Get
		Set
			Me.HtParameter("UnitsOnOrder") = value
		End Set
	End Property
	...
	Public Property ReorderLevel() As Object
		Get
			Return Me.HtParameter("ReorderLevel")
		End Get
		Set
			Me.HtParameter("ReorderLevel") = value
		End Set
	End Property
	...
	Public Property Discontinued() As Object
		Get
			Return Me.HtParameter("Discontinued")
		End Get
		Set
			Me.HtParameter("Discontinued") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_ProductName_forUPD() As Object
		Get
			Return Me.HtParameter("Set_ProductName_forUPD")
		End Get
		Set
			Me.HtParameter("Set_ProductName_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_QuantityPerUnit_forUPD() As Object
		Get
			Return Me.HtParameter("Set_QuantityPerUnit_forUPD")
		End Get
		Set
			Me.HtParameter("Set_QuantityPerUnit_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_UnitsInStock_forUPD() As Object
		Get
			Return Me.HtParameter("Set_UnitsInStock_forUPD")
		End Get
		Set
			Me.HtParameter("Set_UnitsInStock_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_UnitsOnOrder_forUPD() As Object
		Get
			Return Me.HtParameter("Set_UnitsOnOrder_forUPD")
		End Get
		Set
			Me.HtParameter("Set_UnitsOnOrder_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_ReorderLevel_forUPD() As Object
		Get
			Return Me.HtParameter("Set_ReorderLevel_forUPD")
		End Get
		Set
			Me.HtParameter("Set_ReorderLevel_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_Discontinued_forUPD() As Object
		Get
			Return Me.HtParameter("Set_Discontinued_forUPD")
		End Get
		Set
			Me.HtParameter("Set_Discontinued_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property ProductName_Like() As Object
		Get
			Return Me.HtParameter("ProductName_Like")
		End Get
		Set
			Me.HtParameter("ProductName_Like") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property QuantityPerUnit_Like() As Object
		Get
			Return Me.HtParameter("QuantityPerUnit_Like")
		End Get
		Set
			Me.HtParameter("QuantityPerUnit_Like") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property UnitsInStock_Like() As Object
		Get
			Return Me.HtParameter("UnitsInStock_Like")
		End Get
		Set
			Me.HtParameter("UnitsInStock_Like") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property UnitsOnOrder_Like() As Object
		Get
			Return Me.HtParameter("UnitsOnOrder_Like")
		End Get
		Set
			Me.HtParameter("UnitsOnOrder_Like") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property ReorderLevel_Like() As Object
		Get
			Return Me.HtParameter("ReorderLevel_Like")
		End Get
		Set
			Me.HtParameter("ReorderLevel_Like") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property Discontinued_Like() As Object
		Get
			Return Me.HtParameter("Discontinued_Like")
		End Get
		Set
			Me.HtParameter("Discontinued_Like") = value
		End Set
	End Property
	...
	Public Function S1_Insert() As Integer
		...
		Me.SetSqlByFile2("DaoProducts_S1_Insert.sql")
	...
	Public Function D1_Insert() As Integer
		...
		Me.SetSqlByFile2("DaoProducts_D1_Insert.xml")
	...
	Public Sub S2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("DaoProducts_S2_Select.xml")
	...
	Public Sub D2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("DaoProducts_D2_Select.xml")
	...
	Public Function S3_Update() As Integer
		...
		Me.SetSqlByFile2("DaoProducts_S3_Update.xml")
	...
	Public Function D3_Update() As Integer
		...
		Me.SetSqlByFile2("DaoProducts_D3_Update.xml")
	...
	Public Function S4_Delete() As Integer
		...
		Me.SetSqlByFile2("DaoProducts_S4_Delete.xml")
	...
	Public Function D4_Delete() As Integer
		...
		Me.SetSqlByFile2("DaoProducts_D4_Delete.xml")
	...
	Public Function D5_SelCnt() As Object
		...
		Me.SetSqlByFile2("DaoProducts_D5_SelCnt.xml")
