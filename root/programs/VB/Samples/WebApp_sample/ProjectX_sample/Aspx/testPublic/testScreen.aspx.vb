...
Imports Touryo.Infrastructure.Public.Win32
...
#Region "初期化処理"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not Me.IsPostBack Then
            ...
            Me.ddlTimeZone.DataSource = [Enum].GetValues(GetType(MyTimeZoneEnum))
...
#Region "トランザクション制御機能"
    ...
    Protected Sub btnTxGID_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            Dim temp1 As String() = DirectCast(DirectCast(myReturnValue, TestReturnValue).Obj, String())
...
#Region "ローカル⇔UTC対応"
    ...
    Protected Sub btnLocalToUtc_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Me.cbxTimeZone.Checked Then
            ...
            dt = GMTMaster.ConvertLocalTimeToUtcTimeManual(dt, DirectCast([Enum].Parse(GetType(MyTimeZoneEnum), DirectCast(Me.ddlTimeZone.SelectedItem.Text, String)), MyTimeZoneEnum))
        Else
    ...
    Protected Sub btnUtcToLocal_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Me.cbxTimeZone.Checked Then
            dt = GMTMaster.ConvertUtcTimeToLocalTimeManual(dt, DirectCast([Enum].Parse(GetType(MyTimeZoneEnum), DirectCast(Me.ddlTimeZone.SelectedItem.Text, String)), MyTimeZoneEnum))
        Else
...
#Region "その他"
    ...
    Protected Sub btnImpersonation_Click(ByVal sender As Object, ByVal e As EventArgs)
        ' クリア
        Me.lblElse.Text = ""
