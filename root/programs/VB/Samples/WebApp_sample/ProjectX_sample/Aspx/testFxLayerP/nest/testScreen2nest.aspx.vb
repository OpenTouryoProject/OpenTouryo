...
Public Partial Class Aspx_testFxLayerP_normal_testScreen2nest
	...
	Protected Function UOC_testScreen2bmp1_ddlCPF_A_SelectedIndexChanged(fxEventArgs As FxEventArgs) As String
		' メッセージ表示
		Me.ShowOKMessageDialog("ddlCPF_AのSelectedIndexChangedイベント", DirectCast(Me.GetFxWebControl("ddlCPF_A"), DropDownList).SelectedValue, FxEnum.IconType.Information, "ＧＪ！")
	...
	Protected Function UOC_testScreen2bmp2_ddlCPF_A1_SelectedIndexChanged(fxEventArgs As FxEventArgs) As String
		' メッセージ表示
		Me.ShowOKMessageDialog("ddlCPF_A1のSelectedIndexChangedイベント", DirectCast(Me.GetFxWebControl("ddlCPF_A1"), DropDownList).SelectedValue, FxEnum.IconType.Information, "ＧＪ！")
