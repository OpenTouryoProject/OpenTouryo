...
Public Partial Class Aspx_testFxLayerP_normal_testScreen1
	...
	Protected Function UOC_TestScreen1_ibnMImageButton21_Click(fxEventArgs As FxEventArgs) As String
        ' メッセージ表示
        Me.ShowOKMessageDialog(fxEventArgs.ButtonID & "クリック イベント", fxEventArgs.MethodName & "の実行 - " & "x:" & fxEventArgs.X.ToString() & ",y:" & fxEventArgs.Y.ToString(), FxEnum.IconType.Information, "テスト結果")
	...
	Protected Function UOC_TestScreen1_impMImageMap21_Click(fxEventArgs As FxEventArgs) As String
        ' メッセージ表示
        Me.ShowOKMessageDialog(fxEventArgs.ButtonID & "クリック イベント", fxEventArgs.MethodName & "の実行 - " & "pbv:" & fxEventArgs.PostBackValue, FxEnum.IconType.Information, "テスト結果")
