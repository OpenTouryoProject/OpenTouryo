...
#Region "更新系"
    ...
    Protected Function UOC_btnUpdate_Click(fxEventArgs As FxEventArgs) As String
        ' 引数クラスを生成
        Dim parameterValue As New _3TierParameterValue(Me.ContentPageFileNoEx, fxEventArgs.ButtonID, "UpdateRecord", DirectCast(Session("DAP"), String), DirectCast(UserInfoHandle.GetUserInformation(), MyUserInfo))
