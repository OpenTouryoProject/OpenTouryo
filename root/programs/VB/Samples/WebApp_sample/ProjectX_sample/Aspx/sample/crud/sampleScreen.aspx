<%@ Page Language="VB" MasterPageFile="~/Aspx/Common/sampleScreen.master" AutoEventWireup="true" Inherits="ProjectX_sample.Aspx.Sample.Crud.sampleScreen" Codebehind="sampleScreen.aspx.vb" %>
