...
Partial Public Class Aspx_testScreenCtrl_WebForm0
...
#End Region
    ...
    ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
    ''' <returns>URL</returns>
    Protected Function UOC_btnButton29_Click(ByVal fxEventArgs As FxEventArgs) As String
    ...
    ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
    ''' <returns>URL</returns>
    Protected Function UOC_btnButton30_Click(ByVal fxEventArgs As FxEventArgs) As String
        ' 画面遷移（FxTransfer）
        Dim txt As TextBox = DirectCast(Me.GetContentWebControl("TextBox2"), TextBox)
    ...
    ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
    ''' <returns>URL</returns>
    Protected Function UOC_btnButton31_Click(ByVal fxEventArgs As FxEventArgs) As String
        ' 画面遷移（FxRedirect）
        Dim txt As TextBox = DirectCast(Me.GetContentWebControl("TextBox2"), TextBox)
    ...
    ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
    ''' <returns>URL</returns>
    Protected Function UOC_btnButton32_Click(ByVal fxEventArgs As FxEventArgs) As String
        ' 画面遷移（Transfer）
        Dim txt As TextBox = DirectCast(Me.GetContentWebControl("TextBox2"), TextBox)
    ...
    ''' <param name="fxEventArgs">イベントハンドラの共通引数</param>
    ''' <returns>URL</returns>
    Protected Function UOC_btnButton33_Click(ByVal fxEventArgs As FxEventArgs) As String
        ' 画面遷移（Redirect）
        Dim txt As TextBox = DirectCast(Me.GetContentWebControl("TextBox2"), TextBox)
