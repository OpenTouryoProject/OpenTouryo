...
Namespace Aspx.TestScreenCtrl
    ...
    Partial Public Class WebForm0
        ...
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnButton29 As Global.Touryo.Infrastructure.CustomControl.WebCustomButton
        ...
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnButton30 As Global.Touryo.Infrastructure.CustomControl.WebCustomButton
