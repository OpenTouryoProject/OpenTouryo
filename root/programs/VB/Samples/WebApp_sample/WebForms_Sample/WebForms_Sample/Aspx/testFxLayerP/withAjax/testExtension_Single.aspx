<%@ Page Language="VB" MasterPageFile="~/Aspx/Common/Master/testAspNetAjaxExtension_Single.master" AutoEventWireup="true" Inherits="WebForms_Sample.Aspx.TestFxLayerP.WithAjax.testExtension_Single" Codebehind="testExtension_Single.aspx.vb" %>
