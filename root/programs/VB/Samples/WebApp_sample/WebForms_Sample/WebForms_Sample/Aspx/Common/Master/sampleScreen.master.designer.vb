...
Namespace Aspx.Common.Master
    ...
    Partial Public Class sampleScreen
        ...
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents sampleControl1 As Global.WebForms_Sample.Aspx.Common.Wuc.SampleControl
        ...
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents sampleControl2 As Global.WebForms_Sample.Aspx.Common.Wuc.SampleControl
