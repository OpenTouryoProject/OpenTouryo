<%@ Page Language="VB" MasterPageFile="~/Aspx/Common/testBlankScreen.master" AutoEventWireup="true" Inherits="WebForms_Sample.Aspx.TestFxLayerP.testDialogAtOnLoad" Codebehind="testDialogAtOnLoad.aspx.vb" %>
