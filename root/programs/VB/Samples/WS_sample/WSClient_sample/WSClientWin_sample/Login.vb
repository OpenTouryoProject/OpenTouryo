...
Partial Public Class Login
    ...
    Private Async Function ExLogin(userId As String, password As String) As Task(Of String)
        ...
        Dim response As String = Await OAuth2AndOIDCClient.ResourceOwnerPasswordCredentialsGrantAsync(New Uri("http://localhost:63359/MultiPurposeAuthSite/OAuthBearerToken"), OAuth2AndOIDCParams.ClientID, OAuth2AndOIDCParams.ClientSecret, userId, password, "profile email phone address roles").ConfigureAwait(False)
