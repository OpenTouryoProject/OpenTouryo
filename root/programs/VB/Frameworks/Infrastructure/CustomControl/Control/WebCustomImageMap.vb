...
'**********************************************************************************
'* クラス名        ：WebCustomImageMap
'* クラス日本語名  ：イメージマップ（Web）のカスタム・コントロール（テンプレート）
'*
'* 作成者          ：生技 西野
'* 更新履歴        ：
'* 
...
Namespace Touryo.Infrastructure.CustomControl
	''' <summary>イメージマップ（Web）のカスタム・コントロール</summary>
	<DefaultProperty("Text")> _
	<ToolboxData("<{0}:WebCustomImageMap runat=server></{0}:WebCustomImageMap>")> _
	Public Class WebCustomImageMap
		Inherits ImageMap
		''' <summary>
		''' コンストラクタ
		''' </summary>
		Public Sub New()
			...
			Me.Height = 200
			Me.Width = 200
            Me.ImageUrl = GetConfigParameter.GetConfigValue("ImagePath")
        End Sub
