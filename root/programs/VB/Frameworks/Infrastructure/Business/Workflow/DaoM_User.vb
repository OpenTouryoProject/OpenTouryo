...
#Region "プロパティ プロシージャ（setter、getter）"
        ...
        Public Property Section() As Object
            Get
                Return Me.HtParameter("Section")
            End Get
            Set
                Me.HtParameter("Section") = Value
            End Set
        End Property
        ...
        Public Property Name() As Object
            Get
                Return Me.HtParameter("Name")
            End Get
            Set
                Me.HtParameter("Name") = Value
            End Set
        End Property

        ''' <summary>PositionTitlesId列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
        ''' <remarks>更新処理時のSET句で使用するパラメタを除く</remarks>
        Public Property PositionTitlesId() As Object
            Get
                Return Me.HtParameter("PositionTitlesId")
            End Get
            Set
                Me.HtParameter("PositionTitlesId") = Value
            End Set
        End Property
        ...
        ''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
        Public Property Set_Section_forUPD() As Object
            Get
                Return Me.HtParameter("Set_Section_forUPD")
            End Get
            Set
                Me.HtParameter("Set_Section_forUPD") = Value
            End Set
        End Property
        ...
        ''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
        Public Property Set_Name_forUPD() As Object
            Get
                Return Me.HtParameter("Set_Name_forUPD")
            End Get
            Set
                Me.HtParameter("Set_Name_forUPD") = Value
            End Set
        End Property
        ...
        ''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
        Public Property Set_PositionTitlesId_forUPD() As Object
            Get
                Return Me.HtParameter("Set_PositionTitlesId_forUPD")
            End Get
            Set
                Me.HtParameter("Set_PositionTitlesId_forUPD") = Value
            End Set
        End Property
        ...
        ''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
        Public Property Section_Like() As Object
            Get
                Return Me.HtParameter("Section_Like")
            End Get
            Set
                Me.HtParameter("Section_Like") = Value
            End Set
        End Property
        ...
        ''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
        Public Property Name_Like() As Object
            Get
                Return Me.HtParameter("Name_Like")
            End Get
            Set
                Me.HtParameter("Name_Like") = Value
            End Set
        End Property
        ...
        ''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
        Public Property PositionTitlesId_Like() As Object
            Get
                Return Me.HtParameter("PositionTitlesId_Like")
            End Get
            Set
                Me.HtParameter("PositionTitlesId_Like") = Value
            End Set
        End Property
...
#Region "Insert"
        ...
        Public Function S1_Insert() As Integer
            ...
            Me.SetSqlByFile2("DaoM_User_S1_Insert.sql")
        ...
        Public Function D1_Insert() As Integer
            ...
            Me.SetSqlByFile2("DaoM_User_D1_Insert.xml")
...
#Region "Select"
        ...
        Public Sub S2_Select(dt As DataTable)
            ...
            Me.SetSqlByFile2("DaoM_User_S2_Select.xml")
        ...
        Public Sub D2_Select(dt As DataTable)
            ...
            Me.SetSqlByFile2("DaoM_User_D2_Select.xml")
...
#Region "Update"
        ...
        Public Function S3_Update() As Integer
            ...
            Me.SetSqlByFile2("DaoM_User_S3_Update.xml")
        ...
        Public Function D3_Update() As Integer
            ...
            Me.SetSqlByFile2("DaoM_User_D3_Update.xml")
...
#Region "Delete"
        ...
        Public Function S4_Delete() As Integer
            ...
            Me.SetSqlByFile2("DaoM_User_S4_Delete.xml")
        ...
        Public Function D4_Delete() As Integer
            ...
            Me.SetSqlByFile2("DaoM_User_D4_Delete.xml")
...
#Region "拡張メソッド"
        ...
        Public Function D5_SelCnt() As Object
            ...
            Me.SetSqlByFile2("DaoM_User_D5_SelCnt.xml")
