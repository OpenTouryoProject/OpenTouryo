...
using WinServiceProject.Codes.Business;
...
namespace WinServiceProject
{
    public class WinService : System.ServiceProcess.ServiceBase
    {
        ...
        {
            TestParameterValue testparameterValue = new TestParameterValue("WinService", "button", "Start", "SQL" + "%" + "individual" +
        ...
        public void UpdateServiceDataByStatus(object status)
        {
            ...
            TestParameterValue testparameterValue = new TestParameterValue("WinService", "button", "Update", "SQL" + "%" + "individual" +
                                                                            "%" + "Static" + "%" + "-", new MyUserInfo("aaa", "192.168.1.1"));
            testparameterValue.UserId = "A";
            testparameterValue.ExecutionStartDateTime = DateTime.Now;
            testparameterValue.RegistrationDateTime = DateTime.Now;
