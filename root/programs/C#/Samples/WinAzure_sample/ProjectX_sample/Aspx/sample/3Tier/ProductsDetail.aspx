<%@ Page Language="C#" MasterPageFile="~/Aspx/Common/testBlankScreen.master" AutoEventWireup="true" Inherits="Aspx_sample_3Tier_ProductsDetail" Title="Untitled Page" Codebehind="ProductsDetail.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_A" Runat="Server">
    ...
    <asp:Button ID="btnCancel" runat="server" Text="編集を不可能にする" />
