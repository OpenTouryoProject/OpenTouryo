...
//*  日時        更新者            内容
//*  ----------  ----------------  -------------------------------------------------
//*  2015/10/29  Sai               Modified the code of navigating to Crud controller in the Transitions method.         
//**********************************************************************************
...
namespace MVC_Sample.Controllers
{
    ...
    public class Crud2Controller : MyBaseMVController
    {
        ...
        public ActionResult SelectCount(string ddlDap, string ddlMode1, string ddlMode2, string ddlExRollback)
        {
            // 引数クラスを生成
