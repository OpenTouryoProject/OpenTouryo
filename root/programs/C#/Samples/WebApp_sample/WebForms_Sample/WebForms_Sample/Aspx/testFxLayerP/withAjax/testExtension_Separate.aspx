<%@ Page Language="C#" MasterPageFile="~/Aspx/Common/testAspNetAjaxExtension_Separate.master" AutoEventWireup="true" Inherits="WebForms_Sample.Aspx.TestFxLayerP.WithAjax.testExtension_Separate" Codebehind="testExtension_Separate.aspx.cs" %>
