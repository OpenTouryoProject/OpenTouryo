...
//**********************************************************************************
//* クラス名        ：WebCustomPanel
//* クラス日本語名  ：パネル（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>パネル（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomPanel runat=server></{0}:WebCustomPanel>")]
    public class WebCustomPanel : Panel
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public WebCustomPanel()
        {
