...
//**********************************************************************************
//* クラス名        ：WebCustomLinkButton
//* クラス日本語名  ：リンクボタン（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>リンクボタン（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomLinkButton runat=server></{0}:WebCustomLinkButton>")]
    public class WebCustomLinkButton : LinkButton
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
       public WebCustomLinkButton()
       {
