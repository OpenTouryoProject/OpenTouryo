...
//**********************************************************************************
//* クラス名        ：WebCustomCheckBoxList
//* クラス日本語名  ：チェックボックス・リスト（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>チェックボックス・リスト（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomCheckBoxList runat=server></{0}:WebCustomCheckBoxList>")]
    public class WebCustomCheckBoxList : CheckBoxList
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public WebCustomCheckBoxList()
        {
