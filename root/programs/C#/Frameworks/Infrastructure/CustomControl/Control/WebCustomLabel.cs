...
//**********************************************************************************
//* クラス名        ：WebCustomLabel
//* クラス日本語名  ：ラベル（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>ラベル（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomLabel runat=server></{0}:WebCustomLabel>")]
    public class WebCustomLabel : Label
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public WebCustomLabel()
        {
