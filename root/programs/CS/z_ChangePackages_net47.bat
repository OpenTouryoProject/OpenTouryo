...
copy /Y "Frameworks\Infrastructure\Public\Security\packages_net47.config" "Frameworks\Infrastructure\Public\Security\packages.config"
...
copy /Y "Frameworks\Infrastructure\Business\packages_net47.config" "Frameworks\Infrastructure\Business\packages.config"
