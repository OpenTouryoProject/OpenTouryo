...
//**********************************************************************************
//* クラス名        ：WebCustomFileUpload
//* クラス日本語名  ：ファイルアップロード（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>ファイルアップロード（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomFileUpload runat=server></{0}:WebCustomFileUpload>")]
    public class WebCustomFileUpload : FileUpload
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public WebCustomFileUpload()
        {
