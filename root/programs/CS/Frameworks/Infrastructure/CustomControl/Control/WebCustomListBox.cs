...
//**********************************************************************************
//* クラス名        ：WebCustomListBox
//* クラス日本語名  ：リスト・ボックス（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>リスト・ボックス（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomListBox runat=server></{0}:WebCustomListBox>")]
    public class WebCustomListBox : ListBox
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public WebCustomListBox()
        {
