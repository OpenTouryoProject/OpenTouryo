...
//**********************************************************************************
//* クラス名        ：WebCustomRadioButtonList
//* クラス日本語名  ：ラジオボタン・リスト（Web）のカスタム・コントロール（テンプレート）
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//* 
...
{
    /// <summary>ラジオボタン・リスト（Web）のカスタム・コントロール</summary>
    [DefaultProperty("Text")]
    [ToolboxData("<{0}:WebCustomRadioButtonList runat=server></{0}:WebCustomRadioButtonList>")]
    public class WebCustomRadioButtonList : RadioButtonList
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public WebCustomRadioButtonList()
        {
