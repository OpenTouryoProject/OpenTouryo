...
namespace Touryo.Infrastructure.Framework.Exceptions
{
    ...
    public class FrameworkException : Exception
    {
        ...
        /// 自由に利用できる。
        /// </remarks>
        public FrameworkException(string messageID, string message)
            : base(message)
        {
            //メッセージID
        ...
        /// 自由に利用できる。
        /// </remarks>
        public FrameworkException(string messageID, string message, Exception innerException)
