...
//**********************************************************************************
//* クラス名        ：JWS_RS384_Param
//* クラス日本語名  ：ParamによるJWS RS384生成クラス
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//*
...
{
    /// <summary>ParamによるJWS RS384生成クラス</summary>
    public class JWS_RS384_Param : JWS_RS384
    {
        ...
        public JWS_RS384_Param()
        {
            this.DigitalSignParam = new DigitalSignParam(JWS_RS384.DigitalSignAlgorithm);
        }

        /// <summary>Constructor</summary>
        /// <param name="param">RSAParameters</param>
        public JWS_RS384_Param(RSAParameters param)
        {
            this.DigitalSignParam = new DigitalSignParam(param, JWS_RS384.DigitalSignAlgorithm);
        }
