...
//**********************************************************************************
//* クラス名        ：JWS_ES384_X509
//* クラス日本語名  ：X.509証明書によるJWS ES384生成クラス
//*
//* 作成者          ：生技 西野
//* 更新履歴        ：
//*
...
{
    /// <summary>X.509証明書によるJWS ES384生成クラス</summary>
    public class JWS_ES384_X509 : JWS_ES384
    {
        ...
        public JWS_ES384_X509(string certificateFilePath, string password)
        {
            this.CertificateFilePath = certificateFilePath;
            this.CertificatePassword = password;
            this.DigitalSignECDsaX509 = new DigitalSignECDsaX509(
                certificateFilePath, password, HashAlgorithmName.SHA384);
        ...
        public JWS_ES384_X509(string certificateFilePath, string password, X509KeyStorageFlags flag)
        {
            this.CertificateFilePath = certificateFilePath;
            this.CertificatePassword = password;
            this.DigitalSignECDsaX509 = new DigitalSignECDsaX509(
                certificateFilePath, password, HashAlgorithmName.SHA384, flag);
        }
