...
namespace Touryo.Infrastructure.Public.Security
{
    ...
    public class MyDebug : Touryo.Infrastructure.Public.Diagnostics.MyDebug
    {
        #region JWT
            ...
            try
            {
                if (privateX509Key.HasPrivateKey)
                {
                    MyDebug.OutputDebugAndConsole(
                        ...
                        + (AsymmetricAlgorithmCmnFunc.GetPrivateKey(privateX509Key) == null ? "is null" : "is "
                        + AsymmetricAlgorithmCmnFunc.GetPrivateKey(privateX509Key).ToString()));
                }
            }
            catch (Exception ex)
            {
            ...
            if (publicX509Key.PublicKey != null)
            {
                ...
                try
                {
                    ...
                    MyDebug.OutputDebugAndConsole(
                        ...
                        + (AsymmetricAlgorithmCmnFunc.GetPublicKey(publicX509Key) == null ? "is null" : "is "
                        + (AsymmetricAlgorithmCmnFunc.GetPublicKey(publicX509Key).ToString())));
                    //}
                }
                catch (Exception ex)
                {
