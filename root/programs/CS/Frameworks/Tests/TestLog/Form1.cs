...
namespace TestLog
{
    public partial class Form1 : Form
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine(((log4net.Repository.Hierarchy.Logger)log4net.LogManager.GetLogger(Assembly.GetEntryAssembly(), "").Logger).EffectiveLevel.DisplayName);
            System.Diagnostics.Debug.WriteLine(((log4net.Repository.Hierarchy.Logger)log4net.LogManager.GetLogger(Assembly.GetEntryAssembly(), "ACCESS").Logger).Level.DisplayName);
