...
copy /Y "Frameworks\Infrastructure\Public\Security\packages_net46.config" "Frameworks\Infrastructure\Public\Security\packages.config"
...
copy /Y "Frameworks\Infrastructure\Business\packages_net46.config" "Frameworks\Infrastructure\Business\packages.config"
