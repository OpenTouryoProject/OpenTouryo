...
public class Daots_test_tableB : MyBaseDao
{
    #region インスタンス変数
    ...
    public Daots_test_tableB(BaseDam dam) : base(dam) { }
    ...
    public int S1_Insert()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_S1_Insert.sql");
    ...
    public int D1_Insert()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_D1_Insert.xml");
    ...
    public void S2_Select(DataTable dt)
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_S2_Select.xml");
    ...
    public void D2_Select(DataTable dt)
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_D2_Select.xml");
    ...
    public int S3_Update()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_S3_Update.xml");
    ...
    public int D3_Update()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_D3_Update.xml");
    ...
    public int S4_Delete()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_S4_Delete.xml");
    ...
    public int D4_Delete()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_D4_Delete.xml");
    ...
    public object D5_SelCnt()
    {
        ...
        this.SetSqlByFile2("Daots_test_tableB_D5_SelCnt.xml");
