...
Public Class DaoTerritories
	...
	Public Property PK_TerritoryID() As Object
		Get
			Return Me.HtParameter("TerritoryID")
		End Get
		Set
			Me.HtParameter("TerritoryID") = value
		End Set
	End Property



	''' <summary>TerritoryDescription列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタを除く</remarks>
	Public Property TerritoryDescription() As Object
		Get
			Return Me.HtParameter("TerritoryDescription")
		End Get
		Set
			Me.HtParameter("TerritoryDescription") = value
		End Set
	End Property

	''' <summary>RegionID列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタを除く</remarks>
	Public Property RegionID() As Object
		Get
			Return Me.HtParameter("RegionID")
		End Get
		Set
			Me.HtParameter("RegionID") = value
		End Set
	End Property
	...
	Public Property Set_TerritoryID_forUPD() As Object
		Get
			Return Me.HtParameter("Set_TerritoryID_forUPD")
		End Get
		Set
			Me.HtParameter("Set_TerritoryID_forUPD") = value
		End Set
	End Property


	''' <summary>Set_TerritoryDescription_forUPD列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_TerritoryDescription_forUPD() As Object
		Get
			Return Me.HtParameter("Set_TerritoryDescription_forUPD")
		End Get
		Set
			Me.HtParameter("Set_TerritoryDescription_forUPD") = value
		End Set
	End Property


	''' <summary>Set_RegionID_forUPD列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_RegionID_forUPD() As Object
		Get
			Return Me.HtParameter("Set_RegionID_forUPD")
		End Get
		Set
			Me.HtParameter("Set_RegionID_forUPD") = value
		End Set
	End Property
	...
	Public Property TerritoryID_Like() As Object
		Get
			Return Me.HtParameter("TerritoryID_Like")
		End Get
		Set
			Me.HtParameter("TerritoryID_Like") = value
		End Set
	End Property


	''' <summary>TerritoryDescription_Like列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property TerritoryDescription_Like() As Object
		Get
			Return Me.HtParameter("TerritoryDescription_Like")
		End Get
		Set
			Me.HtParameter("TerritoryDescription_Like") = value
		End Set
	End Property


	''' <summary>RegionID_Like列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property RegionID_Like() As Object
		Get
			Return Me.HtParameter("RegionID_Like")
		End Get
		Set
			Me.HtParameter("RegionID_Like") = value
		End Set
	End Property
	...
	Public Function S1_Insert() As Integer
		...
		Me.SetSqlByFile2("DaoTerritories_S1_Insert.sql")
	...
	Public Function D1_Insert() As Integer
		...
		Me.SetSqlByFile2("DaoTerritories_D1_Insert.xml")
	...
	Public Sub S2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("DaoTerritories_S2_Select.xml")
	...
	Public Sub D2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("DaoTerritories_D2_Select.xml")
	...
	Public Function S3_Update() As Integer
		...
		Me.SetSqlByFile2("DaoTerritories_S3_Update.xml")
	...
	Public Function D3_Update() As Integer
		...
		Me.SetSqlByFile2("DaoTerritories_D3_Update.xml")
	...
	Public Function S4_Delete() As Integer
		...
		Me.SetSqlByFile2("DaoTerritories_S4_Delete.xml")
	...
	Public Function D4_Delete() As Integer
		...
		Me.SetSqlByFile2("DaoTerritories_D4_Delete.xml")
	...
	Public Function D5_SelCnt() As Object
		...
		Me.SetSqlByFile2("DaoTerritories_D5_SelCnt.xml")
