...
public class DaoOrder_Details : MyBaseDao
{
    ...
    public int S1_Insert()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_S1_Insert.sql");
    ...
    public int D1_Insert()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_D1_Insert.xml");
    ...
    public void S2_Select(DataTable dt)
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_S2_Select.xml");
    ...
    public void D2_Select(DataTable dt)
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_D2_Select.xml");
    ...
    public int S3_Update()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_S3_Update.xml");
    ...
    public int D3_Update()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_D3_Update.xml");
    ...
    public int S4_Delete()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_S4_Delete.xml");
    ...
    public int D4_Delete()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_D4_Delete.xml");
    ...
    public object D5_SelCnt()
    {
        ...
        this.SetSqlByFile2("DaoOrder_Details_D5_SelCnt.xml");
