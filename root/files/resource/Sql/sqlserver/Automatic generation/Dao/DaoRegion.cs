...
public class DaoRegion : MyBaseDao
{
    #region インスタンス変数
    ...
    public object RegionDescription
    {
        set
        {
            this.HtParameter["RegionDescription"] = value;
        }
        get
        {
            return this.HtParameter["RegionDescription"];
        }
    }
    ...
    /// <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
    public object Set_RegionDescription_forUPD
    {
        set
        {
            this.HtParameter["Set_RegionDescription_forUPD"] = value;
        }
        get
        {
            return this.HtParameter["Set_RegionDescription_forUPD"];
        }
    }
    ...
    /// <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
    public object RegionDescription_Like
    {
        set
        {
            this.HtParameter["RegionDescription_Like"] = value;
        }
        get
        {
            return this.HtParameter["RegionDescription_Like"];
        }
    }
    ...
    public int S1_Insert()
    {
        ...
        this.SetSqlByFile2("DaoRegion_S1_Insert.sql");
    ...
    public int D1_Insert()
    {
        ...
        this.SetSqlByFile2("DaoRegion_D1_Insert.xml");
    ...
    public void S2_Select(DataTable dt)
    {
        ...
        this.SetSqlByFile2("DaoRegion_S2_Select.xml");
    ...
    public void D2_Select(DataTable dt)
    {
        ...
        this.SetSqlByFile2("DaoRegion_D2_Select.xml");
    ...
    public int S3_Update()
    {
        ...
        this.SetSqlByFile2("DaoRegion_S3_Update.xml");
    ...
    public int D3_Update()
    {
        ...
        this.SetSqlByFile2("DaoRegion_D3_Update.xml");
    ...
    public int S4_Delete()
    {
        ...
        this.SetSqlByFile2("DaoRegion_S4_Delete.xml");
    ...
    public int D4_Delete()
    {
        ...
        this.SetSqlByFile2("DaoRegion_D4_Delete.xml");
    ...
    public object D5_SelCnt()
    {
        ...
        this.SetSqlByFile2("DaoRegion_D5_SelCnt.xml");
