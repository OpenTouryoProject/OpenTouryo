...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="18" style="vertical-align: top">C:\root\programs\C#</td><td>1_DeleteDir.bat</td><td>Delete (Clean) the folders that are generated by building.</td><td>○</td><td>○</td>
    </tr>
    <tr>
