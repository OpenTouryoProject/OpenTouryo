...
Install Visual Studio 2010 and the following DBMSs, which are supported by Open Touryo, beforehand.
- SQL Server  
...
Or, confirm the bug with tracking tool, and obtain a difference generated by fixing the bug from *OpenTouryo repository*, and merge the difference to your application.
