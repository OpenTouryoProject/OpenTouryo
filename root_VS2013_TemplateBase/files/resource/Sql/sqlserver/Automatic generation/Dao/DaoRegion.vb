...
Public Class DaoRegion
	...
	''' <summary>RegionID列（主キー列）に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタを除く</remarks>
	Public Property PK_RegionID() As Object
		Get
	...
	''' <summary>RegionDescription列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタを除く</remarks>
	Public Property RegionDescription() As Object
		Get
			Return Me.HtParameter("RegionDescription")
		End Get
		Set
			Me.HtParameter("RegionDescription") = value
		End Set
	End Property
	...
	''' <summary>Set_RegionDescription_forUPD列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_RegionDescription_forUPD() As Object
		Get
			Return Me.HtParameter("Set_RegionDescription_forUPD")
		End Get
		Set
			Me.HtParameter("Set_RegionDescription_forUPD") = value
		End Set
	End Property
	...
	''' <summary>RegionDescription_Like列に対するパラメタ ライズド クエリのパラメタを設定する。</summary>
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property RegionDescription_Like() As Object
		Get
			Return Me.HtParameter("RegionDescription_Like")
		End Get
		Set
			Me.HtParameter("RegionDescription_Like") = value
		End Set
	End Property
	...
	Public Function S1_Insert() As Integer
		...
		Me.SetSqlByFile2("DaoRegion_S1_Insert.sql")
	...
	Public Function D1_Insert() As Integer
		...
		Me.SetSqlByFile2("DaoRegion_D1_Insert.xml")
	...
	Public Sub S2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("DaoRegion_S2_Select.xml")
	...
	Public Sub D2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("DaoRegion_D2_Select.xml")
	...
	Public Function S3_Update() As Integer
		...
		Me.SetSqlByFile2("DaoRegion_S3_Update.xml")
	...
	Public Function D3_Update() As Integer
		...
		Me.SetSqlByFile2("DaoRegion_D3_Update.xml")
	...
	Public Function S4_Delete() As Integer
		...
		Me.SetSqlByFile2("DaoRegion_S4_Delete.xml")
	...
	Public Function D4_Delete() As Integer
		...
		Me.SetSqlByFile2("DaoRegion_D4_Delete.xml")
	...
	Public Function D5_SelCnt() As Object
		...
		Me.SetSqlByFile2("DaoRegion_D5_SelCnt.xml")
