...
Public Class Daots_test_table2
	Inherits MyBaseDao
	#Region "インスタンス変数"
	...
	''' <remarks>更新処理時のSET句で使用するパラメタを除く</remarks>
	Public Property ts() As Object
		Get
			Return Me.HtParameter("ts")
		End Get
		Set
			Me.HtParameter("ts") = value
		End Set
	End Property
	...
	Public Property val() As Object
		Get
			Return Me.HtParameter("val")
		End Get
		Set
			Me.HtParameter("val") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_ts_forUPD() As Object
		Get
			Return Me.HtParameter("Set_ts_forUPD")
		End Get
		Set
			Me.HtParameter("Set_ts_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
	Public Property Set_val_forUPD() As Object
		Get
			Return Me.HtParameter("Set_val_forUPD")
		End Get
		Set
			Me.HtParameter("Set_val_forUPD") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property ts_Like() As Object
		Get
			Return Me.HtParameter("ts_Like")
		End Get
		Set
			Me.HtParameter("ts_Like") = value
		End Set
	End Property
	...
	''' <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
	Public Property val_Like() As Object
		Get
			Return Me.HtParameter("val_Like")
		End Get
		Set
			Me.HtParameter("val_Like") = value
		End Set
	End Property
	...
	Public Function S1_Insert() As Integer
		...
		Me.SetSqlByFile2("Daots_test_table2_S1_Insert.sql")
	...
	Public Function D1_Insert() As Integer
		...
		Me.SetSqlByFile2("Daots_test_table2_D1_Insert.xml")
	...
	Public Sub S2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("Daots_test_table2_S2_Select.xml")
	...
	Public Sub D2_Select(dt As DataTable)
		...
		Me.SetSqlByFile2("Daots_test_table2_D2_Select.xml")
	...
	Public Function S3_Update() As Integer
		...
		Me.SetSqlByFile2("Daots_test_table2_S3_Update.xml")
	...
	Public Function D3_Update() As Integer
		...
		Me.SetSqlByFile2("Daots_test_table2_D3_Update.xml")
	...
	Public Function S4_Delete() As Integer
		...
		Me.SetSqlByFile2("Daots_test_table2_S4_Delete.xml")
	...
	Public Function D4_Delete() As Integer
		...
		Me.SetSqlByFile2("Daots_test_table2_D4_Delete.xml")
	...
	Public Function D5_SelCnt() As Object
		...
		Me.SetSqlByFile2("Daots_test_table2_D5_SelCnt.xml")
