...
public class CustomersEntity
{
    ...
    public bool IsSetPK_CustomerID = false;

    /// <summary>メンバ変数：CustomerID</summary>
    private System.String _PK_CustomerID;

    /// <summary>プロパティ：CustomerID</summary>
    public System.String PK_CustomerID
    {
        get
        {
            return this._PK_CustomerID;
        }
        set
        {
            this.IsSetPK_CustomerID = true;
            this._PK_CustomerID = value;
        }
    }
