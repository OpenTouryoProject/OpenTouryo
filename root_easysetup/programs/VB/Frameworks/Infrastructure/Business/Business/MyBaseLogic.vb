...
Namespace Touryo.Infrastructure.Business.Business
    ...
    Public MustInherit Class MyBaseLogic
        Inherits BaseLogic
...
#Region "例外処理"
        ...
        Protected Overrides Sub UOC_ABEND(ByVal parameterValue As BaseParameterValue, ByVal returnValue As BaseReturnValue, ByVal bsEx As BusinessSystemException)
            ...
            Else
                ...
                ' エラーメッセージID, エラーメッセージ等
                ' ------------
                Dim strLogMessage As String = ((((("," & myPV.User.UserName & ",") & myPV.User.IPAddress & "," & "<<-----" & ",") & myPV.ScreenId & ",") & myPV.ControlId & ",") & myPV.MethodName & ",") & myPV.ActionType & "," & Convert.ToString(Me.perfRec.ExecTime) & "," & Convert.ToString(Me.perfRec.CpuTime) & "," & Convert.ToString(bsEx.messageID) & "," & Convert.ToString(bsEx.Message) & vbCrLf & Convert.ToString(bsEx.StackTrace)
        ...
        Protected Overrides Sub UOC_ABEND(ByVal parameterValue As BaseParameterValue, ByRef returnValue As BaseReturnValue, ByVal ex As Exception)
            ...
            Else
                ...
                ElseIf sysErrorFlag Then
                    ...
                    ' エラーメッセージID, エラーメッセージ等
                    ' ------------
                    Dim strLogMessage As String = ((((("," & myPV.User.UserName & ",") & myPV.User.IPAddress & "," & "<<-----" & ",") & myPV.ScreenId & ",") & myPV.ControlId & ",") & myPV.MethodName & ",") & myPV.ActionType & "," & Convert.ToString(Me.perfRec.ExecTime) & "," & Convert.ToString(Me.perfRec.CpuTime) & "," & sysErrorMessageID & "," & sysErrorMessage & vbCrLf & ex.StackTrace
                ...
                Else
                    ...
                    ' エラーメッセージID, エラーメッセージ等
                    ' ------------
                    Dim strLogMessage As String = ((((("," & myPV.User.UserName & ",") & myPV.User.IPAddress & "," & "<<-----" & ",") & myPV.ScreenId & ",") & myPV.ControlId & ",") & myPV.MethodName & ",") & myPV.ActionType & "," & Convert.ToString(Me.perfRec.ExecTime) & "," & Convert.ToString(Me.perfRec.CpuTime) & "," & "other Exception" & "," & ex.Message & vbCrLf & ex.StackTrace
