...
namespace Touryo.Infrastructure.Public.Db
{
    ...
    public class DamODBC : BaseDam
    {
        ...
        public OdbcConnection DamOdbcConnection
        {
            get
            {
                // コネクションを戻す
        ...
        /// 必要に応じて利用する。
        /// </remarks>
        public OdbcDataAdapter DamOdbcDataAdapter
        {
            get
            {
                // コネクション、トランザクションを設定
                ...
                this._adpt = new OdbcDataAdapter(this._cmd);
        ...
        /// <remarks>必要に応じて利用する。</remarks>
        public OdbcCommand DamOdbcCommand
        {
            get
            {
                // コマンドを戻す
        ...
        {
            // コネクションをオープン
            this._cnn = new OdbcConnection(connstring);
            this._cnn.Open();
        }
            ...
            object dbTypeInfo, int size, ParameterDirection paramDirection)
        {
            ...
            else
            {
                ...
                if (dbTypeInfo != null)
                {
                    ...
                    {
                        // OFF扱い = OdbcType
                        param.OdbcType = (OdbcType)dbTypeInfo;
                    }
                }
        ...
        private void PreExecQuery()
        {
            if (this.IsDPQ)
            {
                ...
                this._cmd.CommandText = this.Convert(DamODBC._paramSign);
        ...
        private void ChangesToOrderBind()
        {
            ...
            foreach (OdbcParameter parameter in this._cmd.Parameters)
            {
            ...
            while(true)
            {
                ...
                paramName = this.GetParamByText(this._cmd.CommandText, DamODBC._paramSign,out paramSignIndex);
                ...
                //this._cmd.CommandText = this._cmd.CommandText.Replace(DamODBC._paramSign + paramName, "?");
                ...
                else
                {
                    ...
                    throw new ArgumentException(string.Format(PublicExceptionMessage.ORDER_BIND_ERROR_PARAMETER_NOT_FOUND, DamODBC._paramSign + paramName));
                }
            }
        }
        ...
        public override string GetCurrentQueryForLog()
        {
            ...
            else if (GetConfigParameter.GetConfigValue(PubLiteral.SQL_TRACELOG).ToUpper() == PubLiteral.ON)
            {
                ...
                // パラメタを取得
                foreach (OdbcParameter p in this._cmd.Parameters)
                {
